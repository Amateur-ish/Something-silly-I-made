...
<header class="container-fluid position-fixed pb-4" style="background-color: yellow;">
    ...
    <h1>CURRENT DAY ATTENDANCE</h1>
    <section class="container rounded mt-3">
      <h3>Login List</h3>
            <table class="table table-bordered table-lg">
              <caption class="text-primary currTime"> 
              AS OF APRIL 26, 2025 (SATURDAY) AT 00:00:00 PM
              </caption>
              <thead class="bg-primary font-weight-bold" style="color: yellow;">         
                <tr>  
                  <th scope="col">#</th>           
                  <th scope="col">ID</th>           
              ...
              <tbody id="tableBody">
                <tr>           
                  ...
                  <td>Tristan C. Unabia</td>           
                  <td>Assistant Principal</td>           
                  <td>April 26, 2025 (Saturday)</td>
                  <td>Time In</td>
                  <td>5:00 PM</td>
                </tr>
              </tbody>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header bg-success ">
            <h5 class="modal-title text-light" id="staticBackdropLabel">You have been marked as attended</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">  
            You have been marked as "Attended". Refresh the page again to see the changes.
          </div>
...
<script src="/ojtproj1/mainpages/javascript/javascripttime.js"></script>
